...
Projectile::Projectile(float tileX, float tileY, float direction, float speed,
                       float flightRange, float explosionRange, float maxDamage) : tileX_(tileX),
                                                                                   tileY_(tileY),
...
void Projectile::update(sf::Time deltaTime, Enemies *enemies)
{
...
std::shared_ptr<Enemy> Projectile::checkHit(Enemies *enemies)
{
...
void Projectile::explode(std::shared_ptr<Enemy> hitEnemy, Enemies *enemies)
{
    if (hitEnemy)
    {
